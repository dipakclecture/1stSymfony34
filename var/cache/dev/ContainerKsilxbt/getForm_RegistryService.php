...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\PostAddType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\PostAddType']) ? $this->services['AppBundle\\Form\\PostAddType'] : ($this->services['AppBundle\\Form\\PostAddType'] = new \AppBundle\Form\PostAddType())) && false ?: '_'};
}, 'AppBundle\\Form\\ProfileAddType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\ProfileAddType']) ? $this->services['AppBundle\\Form\\ProfileAddType'] : ($this->services['AppBundle\\Form\\ProfileAddType'] = new \AppBundle\Form\ProfileAddType())) && false ?: '_'};
    ...
    return ${($_ = isset($this->services['form.type.mongodb_document']) ? $this->services['form.type.mongodb_document'] : $this->load('getForm_Type_MongodbDocumentService.php')) && false ?: '_'};
    ...
    yield 2 => ${($_ = isset($this->services['form.type_guesser.doctrine.mongodb']) ? $this->services['form.type_guesser.doctrine.mongodb'] : $this->load('getForm_TypeGuesser_Doctrine_MongodbService.php')) && false ?: '_'};
}, 3), NULL)], ${($_ = isset($this->services['form.resolved_type_factory']) ? $this->services['form.resolved_type_factory'] : $this->load('getForm_ResolvedTypeFactoryService.php')) && false ?: '_'});
