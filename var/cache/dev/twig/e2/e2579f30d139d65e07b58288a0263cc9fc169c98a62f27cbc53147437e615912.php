...
class __TwigTemplate_6c4d344410fa1c1db0463d55a822f9ea5e16329b9b437a268f7ed41e926ef136 extends \Twig\Template
{
        ...
        if (($this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "user", []) != null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["key"]) {
                ...
                echo "                                <tr>
                                    <td>";
                // line 22
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($context["key"], "Sentby", []), "name", []), "html", null, true);
                echo "</td>
                                    <td> ";
                // line 23
                ...
                echo "</td>
                                    <td>
                                        ";
                // line 25
                if (($this->getAttribute($context["key"], "status", []) == 0)) {
                    // line 26
                    echo "                                        <a href=\"/friendaccept/";
                    echo twig_escape_filter($this->env, $this->getAttribute($context["key"], "id", []), "html", null, true);
                    echo "\" class=\"btn btn-info\">Accept</a>
                                        <a href=\"/friendreject/";
                    // line 27
                    echo twig_escape_filter($this->env, $this->getAttribute($context["key"], "id", []), "html", null, true);
                    echo "\" class=\"btn btn-info\">Reject</a>
                                        ";
                } elseif (($this->getAttribute(                // line 28
$context["key"], "status", []) == 1)) {
                    // line 29
                    echo "                                            Accepted at ";
                    echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($context["key"], "updated", []), "d/m/Y H:i:s A"), "html", null, true);
                    echo "
                                        ";
                } else {
                    // line 31
...
";
    ...
    {
        return array (  145 => 64,  140 => 61,  138 => 60,  135 => 59,  131 => 57,  123 => 33,  117 => 31,  111 => 29,  109 => 28,  105 => 27,  100 => 26,  98 => 25,  93 => 23,  89 => 22,  86 => 21,  82 => 20,  69 => 9,  67 => 8,  60 => 3,  51 => 2,  29 => 1,);
    }
                    ...
                    {% if app.user != null %}
                        <table class=\"table\">
                            ...
                            {% for key in friendList %}
                                <tr>
                                    <td>{{ key.Sentby.name }}</td>
                                    <td> {{ key.created | date(\"d/m/Y H:i:s A\") }}</td>
                                    <td>
                                        {% if key.status ==0 %}
                                        <a href=\"/friendaccept/{{ key.id }}\" class=\"btn btn-info\">Accept</a>
                                        <a href=\"/friendreject/{{ key.id }}\" class=\"btn btn-info\">Reject</a>
                                        {% elseif key.status ==1 %}
                                            Accepted at {{ key.updated | date(\"d/m/Y H:i:s A\") }}
                                        {% else %}
                                            Rejected at {{ key.updated | date(\"d/m/Y H:i:s A\") }}
                                        {% endif %}
                                    </td>
                                </tr>
                            {% endfor %}
