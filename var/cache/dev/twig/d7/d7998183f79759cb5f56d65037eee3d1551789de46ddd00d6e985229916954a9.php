...
/* base.html.twig */
class __TwigTemplate_0fd39732e1599969eb78e1228a58303f5ab6c0d8123287b39f6c00eff061bc3f extends \Twig\Template
{
...
<div class=\"search-bar\">
    <form method=\"GET\" action=\"\" class=\"js-sea-search sea-search\">
        <input type=\"search\" name=\"q\" placeholder=\"Search SocialNet\" autocomplete=\"off\" class=\"search-input\">
    </form>
</div>
<header class=\"header\">
    ...
    <ul class=\"navi\">
        ...
        if (($this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "user", []) == null)) {
            // line 25
            echo "            <a href=\"/login\" class=\"btn btn-info\"> login</a>
...
<div class=\"footer\">
    <p class=\"footer-text\">Made with <span color:red;\">&hearts;</span> <a href=\"https://lecturenotes.in\">LectureNotes</a></p>
</div>
...
";
    ...
    {
        return array (  195 => 45,  192 => 44,  183 => 43,  166 => 36,  154 => 10,  150 => 9,  145 => 8,  136 => 7,  118 => 5,  107 => 47,  105 => 43,  97 => 37,  95 => 36,  89 => 32,  82 => 29,  79 => 28,  74 => 25,  72 => 24,  66 => 21,  53 => 12,  51 => 7,  46 => 5,  40 => 1,);
    }
...
<header class=\"header\">
    ...
    <ul class=\"navi\">
        ...
        {% if not app.user == null %}
            <a href=\"/myprofile\">{{ app.user.name }},</a>
            <a href=\"/logout\" class=\"btn btn-info\"> logout</a>
        {% endif %}
    </ul>
</header>
...
</html>", "base.html.twig", "/home/lap022/code/social/app/Resources/views/base.html.twig");
    }
}
